...
# Gravitational wave resources

1. [Black Hole Perturbation Toolkit](https://bhptoolkit.org/)
2. [Einstein Toolkit](https://einsteintoolkit.org/)
3. [LIGO Open Science Center](https://www.gw-openscience.org/)
4. [Numerical Relativity Wiki](https://numerical-relativity.org/)
5. [PyCBC](https://pycbc.org/)
6. [SXS Gravitational Waveform Database](https://www.black-holes.org)


# Applied Math/Scientific Computing resources

1. Clawpack: [https://www.clawpack.org/](https://www.clawpack.org/)
